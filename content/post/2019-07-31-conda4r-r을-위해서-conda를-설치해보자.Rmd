...
1. `multilinguer::has_conda()`를 쓰세요. (응?)
...
그래서 [conda4r][conda4r] 패키지를 준비했습니다.
[conda4r][conda4r] 패키지는 Windows 32bit, 64bit, MacOS, Linux를 지원하는 [miniconda][miniconda]를 설치하는 함수를 제공합니다.
